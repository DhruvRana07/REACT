...
const Product = () => {
  ...
  const categories = [
    'Electronics', 'Jewellery', 'Home And Kitchen', 'Health And Wellness', 'Books Music And Movies', 
    'Women Fashion', 'Automotive', 'Office Supplies', 'Beauty And Personal Care','Groceries', 
    'Men Fashion', 'Sports And Outdoors', 'Toys And Games', 'Pet Supplies', 'Garden And Outdoor'
  ];
